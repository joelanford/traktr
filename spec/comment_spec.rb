...
describe Traktr::Comment do
  context 'POST methods' do
    before :all do
      @episode_data = { title: 'Dexter', year: '2006', season: '1', episode: '1', comment: "Test comment - #{Time.now}" }
      @movie_data   = { title: 'The Dark Knight Rises', year: '2012', comment: "Test comment - #{Time.now}" }
      @show_data    = { title: 'Dexter', year: '2006', comment: "Test comment - #{Time.now}" }
    end
